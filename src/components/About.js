            ...
            <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-10 py-10 sm:px-4 md:flex-row">
                ...
                <div className="flex flex-col justify-center h-full gap-2">
                    ...
                    <div className="flex items-center"
                        ...
                        <div className="flex bg-third/30 h-[0.01rem] grow ml-5"></div>
                    </div>
                    ...
                    <div className="flex flex-col-reverse sm:flex-row justify-center items-center text-third gap-3"
                        ...
                        data-aos-delay="200">
                        <div>
                            <p className="sm:text-xl text-center text-third">
                        ...
                        <div>
                            <img src={profilePic} alt="My profile pic" className="rounded-full shadow-xl hover:sepia-0 border-2 border-sixth sm:sepia md:rounded-md mx-auto w-2/4 mt-10 md:mt-0 md:w-[80rem] duration-700"></img>
                        </div>
                    </div>
