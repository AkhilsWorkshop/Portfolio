...
const Skills = () => {
    ...
    return (
        <div name="Skills" className="w-full bg-fifth text-secondary">
                ...
                <div className="flex flex-wrap justify-center mt-10"
                    ...
                    {list.map((item) => (
                        <>
                            ...
                            <div key={item.id} className="bg-sixth m-3 p-4 w-16 h-20 sm:h-auto sm:w-24 rounded-md flex flex-col items-center justify-start gap-2 shadow-xl hover:opacity-60 duration-300">
