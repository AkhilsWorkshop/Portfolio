...
const Work = () => {
    return (
        <div name="Work" className="relative min-h-screen w-full bg-gradient-to-b from-black
         bg-fifth text-secondary">
            ...
            <div className="max-w-screen-lg mx-auto flex flex-col h-full px-10 py-20 sm:px-4">
                ...
                <div className="flex flex-col justify-center w-full">
                    ...
                    <ol className="relative border-l border-gray-200 dark:border-gray-700">
                        ...
                        <li className="ml-6">
                            <span className="flex absolute -left-3 justify-center items-center w-6 h-6 rounded-full ring-4 ring-white">
                                <IoMdSchool size={20} />
                            </span>
                            <div className="flex items-center gap-2">
                                <img src={auLogo} alt="AU logo" className="h-10 filter invert-[100%]" />

                                <h3 className="mb-1 text-xl font-semibold text-gray-900 dark:text-white"> Anna University</h3></div>

                            <p className="block my-2 text-sm font-normal leading-none text-gray-400">Bachelor of Engineering - Computer Science Engineering</p>
